...
- `assets/img/brand/hero_ocean.jpg` — the Home page hero background: an actual
  ROMS SST snapshot (2018-08-15) showing mesoscale eddies, not a stock photo.
...
python3 scripts/generate_hero_image.py         # Home page hero background
