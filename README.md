...
- `assets/img/overview/bathymetry_3d.png` — the Home page's 3D "extracted
  slab" view of the model domain (flat ROMS-SST-draped top, real bathymetric
  relief on the bottom face, translucent side walls), generated by
  `scripts/generate_bathymetry_3d.py`.
...
python3 scripts/generate_bathymetry_3d.py      # 3D domain relief for the Home page
