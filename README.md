...
- `roms_cice.html` — "coming soon" page for the ROMS-CICE coupled sea-ice model
  (under development): the same interactive model-domain bathymetry map as
  `about.html`, a real satellite sea-ice concentration image (NASA Earth
  Observatory / NSIDC, public domain) from the 2024 Arctic-wide yearly-maximum
  extent, and a cartoon illustration.
