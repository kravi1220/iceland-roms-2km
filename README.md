...
- `assets/js/bathymetry-3d.js`, `data/bathymetry_3d.json` — the Home page's
  ...
  bathymetry map on `about.html`), land, coastline and side walls. The JSON
  is generated by `scripts/export_bathymetry_3d.py`. (`assets/img/overview/bathymetry_3d.png`
